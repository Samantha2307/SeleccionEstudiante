...
class AsignaturaTestCase ( unittest.TestCase ) :
    def setUp ( self ) :
        ...
        self.asignatura3 = Asignatura(nombreAsignatura="Sistemas Operativos")
    ...
    def test_editar_asignatura(self):
        '''Prueba la edición de dos asignaturas'''
        # Se cambia el nombre de la primera asignatura creada por una que no existe
        resultado1 = self.gestionAsignatura.editar_asignatura(idAsignatura=1, nombreAsignatura="Sistemas de Información")

        # Se cambia el nombre de la segunda asignatura creada por una que ya existe
        resultado2 = self.gestionAsignatura.editar_asignatura(idAsignatura=2, nombreAsignatura="Sistemas Operativos")
    ...
    def test_editar_asignatura_NombreNoNumero( self ) :
        resultado = self.gestionAsignatura.editar_asignatura (idAsignatura="3", nombreAsignatura ="12345")
        self.assertEqual ( resultado , False )